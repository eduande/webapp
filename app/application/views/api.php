                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#p-tombol" type="button" role="tab" aria-controls="" aria-selected="false">Botón de mensaje</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                    ...
                                    <div class="tab-pane fade show active" id="p-text" role="tabpanel" aria-labelledby="pills-home-tab">
                                        <table class="table table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td>número del remitente (debe haber escaneado qr)</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <span class="text-warning">receiver</span>
                                                </td>
                                                <td>destinatarios del mensaje</td>
                                            </tr>
                                            <tr>
                                                <td>
