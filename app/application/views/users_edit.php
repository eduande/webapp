                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                                        ...
                                                        <small>Déjelo en blanco si no desea cambiar su contraseña.</small>
                                                    </div>
                                                </div>
                                                <div id="input_tujuan">
                                                    <label class="form-label">Caducado</label>
                                                ...
                                                <select name="status" class="form-select" aria-label="Default select example">
                                                    <option <?= ($users->status == 'active') ? 'selected' : '' ?> value="1">Activo</option>
                                                    <option <?= ($users->status == 'inactive') ? 'selected' : '' ?> value="2">Inactivo</option>
                                                    <option <?= ($users->status == 'expired') ? 'selected' : '' ?> value="2">Expiración</option>
                                                </select>
                                                <div class="row">
                                                    <div class="col-12 col-xl-6 col-lg-6 col-md-6">
