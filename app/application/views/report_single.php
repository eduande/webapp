                                                    ...
                                                    <tbody>
                                                        <?php foreach ($request->result() as $d) : ?>
                                                            <tr>
                                                                ...
                                                                <td><?= $d->receiver ?></td>
                                                                <td><?= $d->message ?></td>
                                                                <td><?= ($d->media == '') ? '<button class="btn btn-dark btn-sm" disabled>Ninguno</button>' : '<button type="button" class="btn btn-primary btn-sm" onclick="lihat_gambar(`' . $d->media . '`)">Mirar</button>' ?></td>
                                                                <td><?= $d->footer ?></td>
                                                                <td><?= $d->btn1 ?></td>
                                                                <td><?= $d->btn2 ?></td>
                                                                <td><?= $d->btn3 ?></td>
                                                                <td><?= ($d->status == 'Failed') ? '<span class="badge badge-style-light rounded-pill badge-danger">Failed</span>' : '<span class="badge badge-style-light rounded-pill badge-success">Enviar</span>' ?></td>
