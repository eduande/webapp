                            ...
                            <div class="card-body">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#p-text" type="button" role="tab" aria-controls="" aria-selected=" true">Mensaje de texto</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#p-media" type="button" role="tab" aria-controls="" aria-selected="false">Mensaje Media</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#p-tombol" type="button" role="tab" aria-controls="" aria-selected="false">Mensaje con Botón</button>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane fade show active" id="p-text" role="tabpanel" aria-labelledby="pills-home-tab">
                                        ...
                                        <form action="" method="post" class="loadingbtn">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-xl-6">
                                                    <div class="mt-4">
                                                        <textarea name="pesan" class="form-control" rows="10" placeholder="Mensaje" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-xl-6">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <small>Vacío si solo desea enviar un mensaje.</small>
                                                    </div>
                                                </div>
                                                <div class="col-12 col-xl-6">
                                                    <div class="mt-3">
