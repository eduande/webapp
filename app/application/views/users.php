                            ...
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#devices"><i class="material-icons">add</i>Agregar usuarios</button>
                                            ...
                                            <tbody>
                                                <?php foreach ($users->result() as $d) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('users/edit/' . $d->id) ?>" class="btn btn-primary btn-sm">Editar</a>
                                                            <a href="<?= base_url('users/del/' . $d->id) ?>" class="btn btn-danger btn-sm">Eliminar</a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach ?>
                                            </tbody>
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <div id="input_tujuan">
                            <label class="form-label">Caducación</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                <label class="form-label">Dispositivo de límite</label>
