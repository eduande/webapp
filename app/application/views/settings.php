                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <?php } ?>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link <?= ($user->level == 1) ? "" : "active" ?>" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Cuenta</button>
                                    </li>
                                </ul>
                                <br>
                                        ...
                                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                            <form action="<?= base_url('settings/global') ?>" method="post" class="loadingbtn">
                                                ...
                                                <div class="text-end btnkirim mt-3">
                                                    <button type="submit" class="btn btn-primary"><i class="material-icons">save</i>Actualizar</button>
                                                </div>
                                            </form>
                                        </div>
                                    <?php } ?>
