                            ...
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#tab_input" type="button" role="tab" aria-controls="home" aria-selected="true">Aporte</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#tab_datatable" type="button" role="tab" aria-controls="profile" aria-selected="false">Reporte</button>
                                    </li>
                                </ul>
                                <br>
                                                    ...
                                                    <div class="">
                                                        ...
                                                        <div class="form-check">
                                                            ...
                                                            <label class="form-check-label" for="flexCheckDefault">
                                                                Enviar a todos los números (en datos de contactos)
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-off mt-3" id="form-message">
                                                        ...
                                                        <textarea name="pesan" class="form-control" rows="10" placeholder="Nota : {name} Escribe el nombre según el destinatario.
Cuando envíe un archivo pdf, la entrada del mensaje se utilizará para el nombre del archivo pdf." required></textarea>
                                                    </div>
                                                    ...
                                                    <div class="form-off mt-3" id="form-media">
                                                        ...
                                                        <small>Déjelo en blanco si solo desea enviar un mensaje.</small>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <span class="form-off" id="form-button-urlcall">
                                                <div class="row">
                                                    <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                                        <label class="form-label mt-3">Web Url Botón Text</label>
                                                        <input type="text" class="form-control" name="btnurl" placeholder="ex: MI WEB" autocomplete="off">
                                                    </div>
                                                    <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                                    ...
                                                    <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                                        <label class="form-label mt-3">Texto del botón de llamada</label>
                                                        <input type="text" class="form-control" name="btncall" placeholder="ex: CALL ME" autocomplete="off">
                                                    </div>
                                                    <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                                        <label class="form-label mt-3">Número que llama</label>
                                    ...
                                    <div class="tab-pane fade" id="tab_datatable" role="tabpanel" aria-labelledby="profile-tab">
                                        <form action="<?= base_url("schedule/del") ?>" method="post">
                                            <button type="submit" class="btn btn-danger m-1"><i class="material-icons">delete</i>Eliminar</button>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($pesan->result() as $b) : ?>
                                                            <tr>
                                                                ...
                                                                <td><?= $b->nomor ?></td>
                                                                <td><?= $b->pesan ?></td>
                                                                <td><?= ($b->media == '') ? '<button class="btn btn-dark btn-sm" disabled>Ninguno</button>' : '<button type="button" class="btn btn-primary btn-sm" onclick="lihat_gambar(`' . $b->media . '`)">Mirar</button>' ?></td>
                                                                <td><?= $b->footer ?></td>
                                                                <td><?= $b->btn1 ?></td>
                                                                <td><?= $b->btn2 ?></td>
                                                                <td><?= $b->btn3 ?></td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    if ($b->status == 'MENUNGGU JADWAL') {
                                                                        echo '<span class="badge badge-style-light rounded-pill badge-warning">ESPERANDO HORARIO</span>';
                                                                    } else if ($b->status == 'TERKIRIM') {
                                                                        echo '<span class="badge badge-style-light rounded-pill badge-success">ENVIADO</span>';
                                                                    } else if ($b->status == 'GAGAL') {
                                                                        echo '<span class="badge badge-style-light rounded-pill badge-danger">Fallido</span>';
                                                                    }
                                                                    ?>
                                                                </td>
                                                            </tr>
