...
<body>
                        ...
                        <form action="<?= base_url('contacts/del') ?>" method="post">
                            <div class="card widget widget-action-list">
                                <div class="card-body text-center">
                                    <button class="btn btn-danger m-1" type="submit"><i class=" material-icons">delete</i>Eliminar</button>
                              
                                    <button class="btn btn-primary m-1" type="button" data-bs-toggle="modal" data-bs-target="#importexcel"><i class="material-icons">file_upload</i>Importar xlsx</button>
                                    <a href="<?= base_url('excel/export') ?>" class="btn btn-warning m-1"><i class="material-icons">download</i>Exportar xlsx</a>
                                    <button class="btn btn-primary m-1" type="button" data-bs-toggle="modal" data-bs-target="#add"><i class="material-icons">add</i>Agregar</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Agregar un número</h5>
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <input type="number" name="nomor" class="form-control" required placeholder="55xxxx">
    ...
    <div class="modal fade" id="importexcel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Importar xlsx</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="<?= base_url("excel/import") ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="mb-1">
                            <label for="formFile" class="form-label">Archivo Excel <small style="font-size: 9px;">(.xlsx)</small></label>
                        ...
                        <div class="collapse" id="advance">
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Comenzar desde la línea</label>
                                <input type="text" name="a" class="form-control" id="basicInput" value="2" required />
                            </div>
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Nombre de columna a</label>
                                <input type="text" name="b" class="form-control" id="basicInput" value="1" required />
                            </div>
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Número de columna a</label>
                                <input type="text" name="c" class="form-control" id="basicInput" value="2" required />
                            </div>
                            <div class="mb-1">
                                <label class="form-label" for="basicInput">Etiqueta de columna a</label>
    ...
    <div class="modal fade" id="generates" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Recuperar contactos</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
