                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-off mb-2" id="form-message">
                                                        ...
                                                        <textarea name="pesan" class="form-control" rows="7" placeholder="Ex : Hola {name}
Nota : {name} escribe el nombre según el destinatario.
Cuando envíe un archivo pdf, la entrada del mensaje se utilizará para el nombre del archivo pdf." required></textarea>
                                                    ...
                                                    <span class="form-off" id="form-button-urlcall">
                                                        <div class="row">
                                                            <div class="col-12 col-xl-6 col-lg-6 col-md-6">
                                                                <label class="form-label">Web Url Botón Text</label>
                                                        ...
                                                        <?php foreach ($blast->result() as $b) : ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                    if ($b->status == 'pending') {
                                                                        echo '<span class="badge badge-style-light rounded-pill badge-warning">Pendiente</span>';
