                                    ...
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Número de contactos</span>
                                                <span class="widget-stats-amount"><?= $contacts ?></span>
                                                <span>Número guardado.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Dispositivos</span>
                                ...
                                <div class="card widget widget-stats">
                                    <div class="card-body">
                                        <div class="widget-stats-container d-flex">
                                            ...
                                            <div class="widget-stats-content flex-fill">
                                                <span class="widget-stats-title">Programar mensaje</span>
                                                <span class=""><small>Pendiente : <?= $pending ?> <br> Fallido : <?= $gagal ?> <br> Enviar : <?= $terkirim ?></small></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="card">
                                    <div class="card-body">
                                        <h5>Dispositivos</h5>
                                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#devices"><i class="material-icons">add</i>Agrega un nuevo dispositivo</button>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Añadir dispositivo</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="post">
                    <div class="modal-body">
                        <label class="form-label">Número</label>
                        <input type="number" name="nomor" class="form-control" required placeholder="sin el signo +">
