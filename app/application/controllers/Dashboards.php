...
class Dashboards extends CI_Controller
{
  ...
  public function device()
  {
    ...
    if ($this->input->post()) {
      ...
      $this->session->set_flashdata('success', 'Actualice correctamente el dispositivo.');
  ...
  public function device_delete()
  {
    ...
    $this->session->set_flashdata('success', 'El dispositivo se ha eliminado correctamente.');
    redirect(base_url());
  }
  ...
  public function autoresponder()
  {
    if ($this->input->post()) {
      ...
      $this->session->set_flashdata('success', 'Respuesta automática agregada con éxito.');
  ...
  public function autoresponder_del()
  {
    ...
    $this->session->set_flashdata('success', 'Respuesta automática eliminada con éxito.');
    redirect(base_url('autoresponder'));
  }
  public function autoresponder_view()
  {
    $id = htmlspecialchars(str_replace("'", "", $this->uri->segment(3)));
    $data['title'] = 'Vista de respuesta automática';
  ...
  public function contacts()
  {
    if ($this->input->post()) {
      ...
      if ($this->db->get_where('nomor', ['nomor' => $nomor])->num_rows() == 0) {
        ...
        $this->session->set_flashdata('success', 'Número agregado con éxito.');
  ...
  public function get_contacts()
  {
    if ($this->input->post()) {
      ...
      $this->session->set_flashdata('success', 'Contactos recuperados con éxito.');
      redirect(base_url('contacts'));
    }
  }
  ...
  public function contacts_del()
  {
    if (isset($_POST['id'])) {
      ...
      $this->session->set_flashdata('success', 'Eliminar con éxito el número en la lista de verificación.');
      redirect(base_url('contacts'));
    } else {
      $this->session->set_flashdata('error', 'lista de verificación que desea eliminar.');
      redirect(base_url('contacts'));
    }
  }
  ...
  public function blast()
  {
    if ($this->input->post()) {
      ...
      $res = ['status' => true];
      if ($res['status'] == true) {
        $this->session->set_flashdata('success', 'Envíe el mensaje con éxito, el estado del mensaje se puede ver en la tabla debajo de esta página.');
        redirect(base_url('blast'));
      } else {
        $this->session->set_flashdata('error', 'Escanear el QR primero.');
        redirect(base_url('blast'));
      }
    } else {
  ...
  public function blast_del()
  {
    if (isset($_POST['id'])) {
      ...
      $this->session->set_flashdata('success', 'Eliminar con éxito la explosión en la lista de verificación.');
      redirect(base_url('blast'));
    } else {
      $this->session->set_flashdata('error', 'lista de verificación que desea eliminar.');
      redirect(base_url('blast'));
  ...
  public function schedule()
  {
    ...
    if ($this->input->post()) {
      ...
      $this->session->set_flashdata('success', 'Enviar correctamente el mensaje programado.');
  ...
  public function schedule_del()
  {
    if (isset($_POST['id'])) {
      ...
      $this->session->set_flashdata('success', 'Elimine con éxito el horario en la lista de verificación.');
      redirect(base_url('schedule'));
    } else {
      $this->session->set_flashdata('error', 'lista de verificación que desea eliminar.');
      redirect(base_url('schedule'));
  ...
  public function users()
  {
    ...
    if ($uw->level == 2) {
      $this->session->set_flashdata('error', 'Solo para nivel de administrador.');
      redirect(base_url());
    }
    if ($this->input->post()) {
      $username = _POST('username');
  ...
  public function users_edit()
  {
    ...
    if ($this->input->post()) {
      ...
      $this->session->set_flashdata('success', 'Se ha añadido la cuenta.');
      redirect(base_url('users'));
    } else {
      $data = [
  ...
  public function users_del()
  {
    ...
    $this->session->set_flashdata('success', 'La cuenta ha sido eliminada.');
    redirect(base_url('users'));
  }
}
